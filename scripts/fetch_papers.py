...
CURATED_PAPERS = [
    ...
    },
    {
        ...
        "summary": "Presents Kuaishou's production-scale end-to-end generative recommendation system, replacing cascaded recall/rank stages with a unified generative architecture, scaling recommendation FLOPs and improving MFU, communication cost and app-level engagement.",
        "reason": "快手推荐算法大模型主线：OneRec 已在快手/快手极速版部署到 25% QPS，论文给了端到端生成式推荐、Scaling Law、MFU、OPEX 和 App Stay Time 的完整工业口径。",
        "area": "推荐算法",
        "tags": ["kuaishou", "onerec", "generative-recommendation", "scaling-law", "production"],
        "signal": 100,
        "source": "Kuaishou/arXiv",
        "published_at": "2025-06-16T16:58:55Z",
        "url": "https://arxiv.org/abs/2506.13695",
        "pdf_url": "https://arxiv.org/pdf/2506.13695",
    },
    {
        "mode": "recent",
        "id": "arxiv-2604.04976",
